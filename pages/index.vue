<template>
  <div class="flex flex-col justify-center items-center">
    <svg @click="openAdd" class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50"
      viewBox="0 0 50 50">
      <path
  ...
  <EditPost v-if="isOpen" @closeEdit="closeEdit" :selectedPost="selectedPost" />
  <Delete v-if="isOpenDelete" @updatePosts="updatePosts" @closeDelete="closeDelete" :selectedPost="selectedPost" />
